...
from train import KFoldMultiSIPTrainer,DeepInterAwareTrainer
from utils.comm_utils import set_seed, EvaMetric, return_loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./configs/HIV.yml', type=str, metavar='S', help='pretrain model')
    ...
    for seed in range(0,5):
        ...
        # print(f'/home/u/data/xyh/project/interface_aware/result/HIV/DeepInterAware/batch_256_epoch_50_seed_0_transfer_ablang_bn/best_modelpth')
        model_path = f'{os.getcwd()}/result/HIV/DeepInterAware/batch_256_epoch_50_seed_{seed}_transfer_ablang_bn/'
        ...
        model = model.to(device)
        result_table = merge_finetune(train_loader, test_loader, model, model_path, args.freeze, args.alpha)
        file = os.path.join(model_path, f"CoVAbDab_{seed}_{args.alpha}.csv")
