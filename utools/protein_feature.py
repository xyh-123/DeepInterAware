...
if __name__ == '__main__':
    ...
    datafolder = os.path.join(project_dir,'data','HIV/')
    ...
    ag_ft=get_esm2_Seq_feature(ag_list)
    ablang_ft = get_ablang_Seq_feature(ab_list)
    antiberty_ft = get_antiberty_Seq_feature(ab_list)